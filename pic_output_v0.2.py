# coding=UTF-8
import glob,os,re,sqlite3,shutil,stat,sys,time,zipfile,zlib


#定义数据库，图片及临时文件夹的路径
database_path = "c:/test/new/database/ec.db"
ecimage_path = "c:/test/new/EconomicCensus/"
...
for i in taskid:
    ...
    output_zip = zipfile.ZipFile("c:/test/" + 'PICTURE_' + taskid_output + pcxqDeivceNo + ctime + '.zip' ,'w',zipfile.ZIP_DEFLATED)
